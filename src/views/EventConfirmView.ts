  ...
  return `
    <div class="screen-content confirm-manifest-page" id="screen-confirm-manifest">
        ...
        <div class="manifest-tri-metric-row">
          ...
          <div class="manifest-metric-col">
            ...
            <div class="manifest-metric-content">
              <span class="manifest-metric-val">${eventCount} <span style="font-size: 10px; font-weight: 500; opacity: 0.85;">EVENTS</span></span>
          ...
          <div class="manifest-metric-col">
            ...
            <div class="manifest-metric-content">
              ...
              <span class="manifest-metric-val" style="font-size: 11px;">EVENTS</span>
            </div>
          </div>
        </div>
        ...
        <div class="manifest-events-timeline">
          ...
          ${items
            ...
            <div class="manifest-event-row">
              ...
              <div class="manifest-event-index">${item.indexStr}</div>
              ...
              <div class="manifest-event-card">
                ...
                <div class="manifest-event-info">
                  <div class="manifest-event-name">${escapeHtml(item.name)}</div>
      ...
      <div class="confirm-actions-wrap">
        ...
        <button class="confirm-btn-primary-chamfer" id="btn-confirm-view-my-events">
          <div class="confirm-btn-label-group">
            ...
            <span class="confirm-btn-text">View My Events</span>
          </div>
        ...
        <!-- Secondary Button: Explore More Events -->
        <button class="confirm-btn-secondary-chamfer" id="btn-confirm-explore-more">
          <div class="confirm-btn-label-group">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              <circle cx="12" cy="12" r="10"/>
...
export function attachEventConfirmEvents(): void {
  ...
  const btnViewMyEvents = document.getElementById('btn-confirm-view-my-events');
  if (btnViewMyEvents) {
    btnViewMyEvents.addEventListener('click', () => {
